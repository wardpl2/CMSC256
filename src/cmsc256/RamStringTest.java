...
public class RamStringTest {
    ...
    public void ramifyString() {
        ...
        assertTrue("Go VCU and CS@VCU and 000".equals(expectedString.getWackyString()));
    }
    @Test
    public void ramifyString2() {
        RamString onlyZeros = new RamString("00000");
        onlyZeros.ramifyString();
        assertTrue("00000".equals(onlyZeros.getWackyString()));
    }
    @Test
    public void ramifyString3() {
        RamString spaceSeparated = new RamString("0 00 0");
        spaceSeparated.ramifyString();
        assertTrue("Go VCU CS@VCU Go VCU".equals(spaceSeparated.getWackyString()));
    }
    ...
    public void convertDigitsToRomanNumeralsInSubstring() {
        ...
        assertTrue("I am IIX years old".equals(normalString.getWackyString()));
    }
    @Test
    public void convertDigitsToRomanNumeralsInSubstring2() {
        ...
        assertTrue("I am 1IX years old".equals(restrictedString.getWackyString()));
    }
    @Test
    public void convertDigitsToRomanNumeralsInSubstring3() {
        ...
        assertTrue("IIIIIIIVVVIVIIVIIIIX0".equals(numberString.getWackyString()));
    }
